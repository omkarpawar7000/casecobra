...
const OrderReceivedEmail = ({
    ...
    const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://casecobra-vert.vercel.app'
                    ...
                    <Section style={paddingY}>
                        <Row>
                            <Text style={{
                                ...
                                Please contact us if you have any questions. (If you reply this email, we won't be able to see it.)
                            </Text>
                        </Row>
                        <Row>
